...
When those glasses become full, any excess champagne will fall equally to the 
left and right of those glasses, and so on.  
...
const champagneFullTower = (poured, rows = 4) => {
  // Initialze the tower as a nested array representing the first cup.
  // This first cup is where all of the liquid poured initially goes.
  const tower = [[poured]]

  // Iterate for each row of the tower that we are modelling.
...
console.log(champagneFullTower(5))
