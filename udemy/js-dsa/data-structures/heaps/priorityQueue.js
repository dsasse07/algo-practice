...
class PriorityQueue {
  ...
  enqueue(value, priority) {
    ...
    while (
      currentIdx !== 0 &&
      this.values[currentIdx].priority < this.values[parentNodeIdx].priority
    ) {
  ...
  dequeue() {
    ...
    while (true) {
      ...
      if (
        ...
        this.values[currentIdx].priority > this.values[leftChildIdx].priority
      ) {
      ...
      if (
        ...
        ((swapIdx === null &&
          this.values[currentIdx].priority >
